...
colnames(dat_int) = c("LoS","0visit","1visits","3visits","3visits","4visits","+5visits")
dat_int = dat_int%>%mutate(LoS = replace(LoS, LoS == '9+', 9))

dat_int[c("0visit","1visits","3visits","3visits","4visits","+5visits")] = 100*prop.table(100*as.matrix(subset(dat_int,select = c("0visit","1visits","3visits","3visits","4visits","+5visits"))),2)
