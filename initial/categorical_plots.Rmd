...
colnames(dat_int) = c("LoS","value0","value1","value2","value3","value4","value5")
dat_int = dat_int%>%mutate(LoS = replace(LoS, LoS == '9+', 9))

dat_int[c("value0","value1","value2","value3","value4","value5")] = 100*prop.table(100*as.matrix(subset(dat_int,select = c("value0","value1","value2","value3","value4","value5"))),2)
